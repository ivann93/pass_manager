...
<!--                                <a href="#" class="delete_data" id="<?php echo $value2->id; ?>"> <i class="glyphicon glyphicon-trash"></i></a> -->
 ...
 <div id="projectname">             
                    ...
                    <div class="col-sm-12 col-xs-12">
                       ...
                       <center>  <div id="celo">
                        <?php if($projectid!=0){ ?>
                            <form method="post" action="<?php echo base_url()?>index.php/ProjectsController/form_validation_update2" enctype="multipart/form-data">                              
                        <?php }else{ ?>
                            <form method="post" action="<?php echo base_url()?>index.php/ProjectsController/form_validation2" enctype="multipart/form-data">
                        <?php } ?>      
