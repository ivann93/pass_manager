...
<center>  <div id="celo">
                            <form method="post" action="<?php echo base_url()?>index.php/ProjectsController/form_validation_subproject2" enctype="multipart/form-data" >
                                  ...
                                  <br> <center><h1>Create new subproject</h1></center><br>
...
/*  width:auto !important;*/
  width:250px !important;
                            ...
                            <div class="hr-line2">
                             ...
                             <br><input type="submit" id="kopceInsert1" name="insert" value="Insert" class="btn btn-info pull-right" />   <a href="<?php echo base_url()?>index.php/Main/dataUser" id="cancelButton" class="btn btn-info pull-right">Cancel</a>    
