...
// print_r($userdata);
                        ?>
                        <center><h1>Edit <?php echo $userdata[0]->customerName ?></h1></center>
...
<!--                                 <br><label>Tags</label>  <br>
                                <input type="tag" name="tag"  id="p3" required <?php if($user_id!=0){ ?> value="<?php echo $userdata[0]->tag ?>" <?php } ?> />  <br> 
                                <span class="text-danger"><?php echo form_error("tag"); ?></span>  <br> -->
                            ...
                            <div id="tagform" style="display: none;">
                              ...
                              <!--   <form action='' method='post'>
                                <select name="myselectbox">
                                   <option name="level" value="myoption1">Level 1 (Admin)</option>
                                   <option name="level" value="myoption2">Level 2 (Normal user)</option>
                                </form> -->
                     
                        <!--         <label>Level</label>  <br>
                                <input type="level" name="level"  id="p4" required/>  <br> 
                     ...
                     <?php if($user_id!=0){ ?>
                      ...
                      <br><div class="hr-line2">
                      </div><br></center>

                    

                   <input type="submit" id="kopceInsert2" name="update" value="Update" class="btn btn-info pull-right" />      <a href="<?php echo base_url()?>index.php/Main/users" class="btn btn-info pull-right" id="cancel">Cancel</a> 
                     <?php } else{ ?>
                      <input type="submit" id="kopceInsert3" name="insert" value="Insert" class="btn btn-info" /> 
                     <?php } ?>
                      </div>
                </form>
              </div>
