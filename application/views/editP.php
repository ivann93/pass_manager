                    ...
                    <div class="col-sm-12 col-xs-12">
                       ...
                       <center>  <div id="celo">
                        ...
                        <?php } ?>      
                                  ...
                                  ?>
                                  <br><br>   <center><h1>Edit <?php echo $projectdata[0]->name ?></h1></center>
                                 <?php if($projectdata[0]->pic !=''){ ?>
                                  ...
                                  <div id="blahdiv" <?php echo $str; ?> >

                                   <img id="blah" src="<?php echo base_url(); ?>upload/<?php echo $projectdata[0]->pic ;?>" alt="your image" width='150px' height='150px' />
                                  </div><br>

                                  <div id="blahdiv1" style="display: none;" >

                                   <img id="blah1" src="<?php echo base_url(); ?>upload/<?php echo $projectdata[0]->pic ;?>" alt="your image" width='150px' height='150px' />
                                  </div><br>
                                ...
                                <div class="col-sm-12 col-xs-12 col-lg-6">
                                  ...
                                  <div class="col-sm-12 col-xs-12 col-lg-6 col-md-12">
                                        ...
                                        <input type="text" name="password" id="pass2" required <?php if($projectid!=0){ ?> value="<?php echo $projectdata[0]->password ?>" <?php } ?> />   <!-- class="form-control" -->  <br>
                                  ...
                                  <div class="col-sm-6 col-xs-6">
                                        ...
                                        <label>Attached picture:</label><?php if($projectid!=0){ ?> <?php echo $projectdata[0]->pic ?> <?php } ?>
                                        <input type="hidden" name="oldfilename" value="<?php echo $projectdata[0]->pic ?>">                                        
                                ...
                                <br>
                                 ...
                                 <br> 
                                    ...
                                    <?php if($projectid!=0){ ?>
                                      ...
                                      <input type="submit" id="kopceInsert8" name="update" value="Update" class="btn btn-info pull-right" />   <a href="<?php echo base_url()?>index.php/Main/data" id="cancelButton" class="btn btn-info pull-right" >Cancel</a>
                                    <?php }else{ ?>
